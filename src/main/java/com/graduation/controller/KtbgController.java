...
import com.graduation.service.KtbgService;
...
public class KtbgController {
	...
	@ResponseBody
		...
		public boolean insertSelective(@RequestBody Ktbg ktbg) {
	...
	public String gotoTktbg(@RequestParam(required=true)String studentId) {
		return "redirect:http://localhost:8081/#/tktbg?studentId="+studentId;
	}
	...
	public boolean updateByPrimaryKeySelective(@RequestBody Ktbg ktbg) {
